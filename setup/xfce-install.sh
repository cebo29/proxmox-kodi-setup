...
echo "  • Launch from Kodi: Add-ons → Programs → RetroArch"
echo "  • Launch from desktop: RetroArch shortcut"
echo "  • Install cores from: RetroArch → Online Updater → Core Downloader"
echo ""
